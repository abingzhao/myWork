...
template <typename T>
void QuickSort(T* inPtr,int lowIdx, int highIdx)
{
    if(lowIdx<highIdx)
    {
        int n = Partion(inPtr,lowIdx,highIdx);
        QuickSort(inPtr,lowIdx,n);
        QuickSort(inPtr,n+1,highIdx);
    }
...
int main(int argc, char const *argv[])
{
    ...
    // int seq[10] = {5,1,2,3,0,6,7,8,4,9};

...
public class FormulaBasedLinearList extends LinearList
{
   // data members
   protected Object [] element;  // array of elements
   protected int capacity;       // array size
   ...
   {
      return new FormulaBasedLinearListIterator
                 (this);
   }
